    ...
    <div className={`navbar fixed w-full transition-all ${scrollActive}`}>
      <div className="container mx-auto px-4">
        <div className="navbar-box flex items-center justify-between">
          <div className="logo">
            <h1 className="sm:text-2xl text-xl font-bold">LensaKulitku</h1>
          </div>
          <ul
          ...
          >
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="#features" className="font-medium opacity-75">
                Features
              </a>
            </li>
            <li className="flex items-center gap-3">
              <i className="ri-article-line text-3xl md:hidden block"></i>
              <a href="#ourteam" className="font-medium opacity-75">
                Our Team
              </a>
            </li>
          </ul>
